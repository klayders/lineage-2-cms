...
public class VoteMMOTOPService {
  @Value("${vote.mmotop.enable}")
  private boolean mmotopEnable;
  @Value("${vote.mmotop.id}")
  private int mmotopId;
  @Value("${vote.mmotop.link}")
  private String mmotopLink;
  @Value("${vote.mmotop.itemId}")
  private int mmotopItemId;
  @Value("${vote.mmotop.itemCount}")
  private long mmotopItemCount;
